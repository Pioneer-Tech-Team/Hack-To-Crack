          ...
          <div className="timeline" id="timeline">
            <div className="container" id="timeline-container">
              ...
              <p className="container-description">
                 "Calling all aspiring tech enthusiasts, developers, and
                 problem solvers from diverse backgrounds! Registration is
                 now open for students eager to dive into an exciting 40 hours of 
                 coding, collaboration, and competition. Join us as we tackle real-world 
                 challenges, develop cutting-edge solutions, and pave the way for a
                 thrilling learning experience. Don't miss this opportunity to
                  showcase your skills and unleash your creativity
                 – it's your chance to be part of something extraordinary!"
              </p>
